...
in
{
  ...
  environment.sessionVariables.NIX_GSETTINGS_OVERRIDES_DIR = lib.mkIf cinnamon.enable (
    lib.mkForce "${cinnamonGSettingsOverrides}/share/gsettings-schemas/nixos-gsettings-overrides/glib-2.0/schemas"
  );
}
